    ...
    def test_create_project_example(self):
        ...
        try:
            ...
            project_config_definition_prototype_model = {
                'locator_id': '1082e7d2-5e2f-0a11-a3bc-f88a8e1931fc.018edf04-e772-4ca2-97851082e7d2-5e2f-0a11-a3bc-f88a8e1931fc.145be7c1-9ec4-4719-b586-584ee52fbed0-global',
            ...
            print(project_id_link)
            print("pppp", project_id_link)
