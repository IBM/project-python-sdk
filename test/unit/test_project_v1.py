...
class TestModel_ProjectComplianceProfile:
    ...
    def test_project_compliance_profile_serialization(self):
        ...
        project_compliance_profile_model_json['instance_location'] = 'us-south'
