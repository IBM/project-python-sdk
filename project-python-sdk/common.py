...
import platform
from project-python-sdk.version import __version__

HEADER_NAME_USER_AGENT = 'User-Agent'
SDK_NAME = 'project-python-sdk'
...
def get_sdk_headers(service_name, service_version, operation_id):
    ...
    project-python-sdk/0.0.1 (lang=python; arch=x86_64; os=Linux; python.version=3.7.4)

    In the example above, the analytics tool will parse the user-agent header and
    use the following properties:
    "project-python-sdk" - the name of your sdk
