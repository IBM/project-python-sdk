...
class ProjectV1(BaseService):
    ...
    def create_project(
        ...
        **kwargs,
        ...
        :param str description: (optional) A project's descriptive text.
    ...
    def delete_project(
        ...
        **kwargs,
        ...
        :param str id: The unique project ID.
        :param bool destroy: (optional) The flag that indicates if the resources
               deployed by Schematics should be destroyed.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def create_config(
        ...
        **kwargs,
        ...
        :param str id: (optional) The ID of the configuration. If this parameter is
               empty, an ID is automatically created for the configuration.
        :param List[str] labels: (optional) A collection of configuration labels.
        :param str description: (optional) The project configuration description.
        :param ProjectConfigAuth authorizations: (optional) The authorization for a
               configuration. You can authorize by using a trusted profile or an API key
               in Secrets Manager.
        ...
        :param List[ProjectConfigSettingCollection] setting: (optional) Schematics
               environment variables to use to deploy the configuration.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def approve(
        ...
        **kwargs,
        ...
        :param str project_id: The unique project ID.
        :param str id: The unique config ID.
        :param str comment: (optional) Notes on the project draft action.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ProjectConfigGetResponse` object
        """
    ...
    def check_config(
        ...
        **kwargs,
        ...
        :param bool is_draft: (optional) To specify whether the validation check
               should trigger against the draft or the active version of the
               configuration.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ProjectConfigGetResponse` object
    ...
    def get_config_draft(
        ...
        **kwargs,
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ProjectConfigDraft` object
        """
...
class Project:
    ...
    :attr str name: The project name.
    :attr str description: (optional) A project descriptive text.
    ...
    :attr ProjectMetadata metadata: (optional) The metadata of the project.
    :attr List[ProjectConfig] configs: (optional) The project configurations.
    """
    ...
    def __init__(
        ...
        *,
        ...
        configs: List['ProjectConfig'] = None,
    ) -> None:
        """
        ...
        :param str description: (optional) A project descriptive text.
        :param bool destroy_on_delete: (optional) The policy that indicates whether
               the resources are destroyed or not when a project is deleted.
        :param ProjectMetadata metadata: (optional) The metadata of the project.
        :param List[ProjectConfig] configs: (optional) The project configurations.
        """
        self.name = name
        self.description = description
    ...
    def from_dict(cls, _dict: Dict) -> 'Project':
        ...
        if 'metadata' in _dict:
            args['metadata'] = ProjectMetadata.from_dict(_dict.get('metadata'))
        if 'configs' in _dict:
            args['configs'] = [ProjectConfig.from_dict(v) for v in _dict.get('configs')]
        return cls(**args)
...
class ProjectCollectionMemberWithMetadata:
    ...
    :attr str name: (optional) The project name.
    :attr str description: (optional) The project description.
    :attr ProjectMetadata metadata: (optional) The metadata of the project.
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param str description: (optional) The project description.
        :param ProjectMetadata metadata: (optional) The metadata of the project.
        """
        self.id = id
        self.name = name
...
class ProjectConfig:
    ...
    :attr str id: (optional) The ID of the configuration. If this parameter is
          empty, an ID is automatically created for the configuration.
    :attr str name: The configuration name.
    :attr List[str] labels: (optional) A collection of configuration labels.
    :attr str description: (optional) The project configuration description.
    :attr ProjectConfigAuth authorizations: (optional) The authorization for a
          configuration. You can authorize by using a trusted profile or an API key in
          Secrets Manager.
    ...
    def from_dict(cls, _dict: Dict) -> 'ProjectConfig':
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in ProjectConfig JSON')
        if 'labels' in _dict:
        ...
        if 'locator_id' in _dict:
            ...
            raise ValueError('Required property \'locator_id\' not present in ProjectConfig JSON')
        if 'type' in _dict:
            args['type'] = _dict.get('type')
        else:
            raise ValueError('Required property \'type\' not present in ProjectConfig JSON')
        if 'input' in _dict:
...
class ProjectConfigCollection:
    ...
    :attr str project_id: (optional) The unique ID of a project.
    ...
    def __init__(
        ...
        *,
        ...
        :param str project_id: (optional) The unique ID of a project.
...
class ProjectConfigCollectionMember:
    ...
    :attr ProjectConfigMetadataCommon metadata: (optional) The configuration
          metadata.
    """
    ...
    def __init__(
        ...
        *,
        ...
        href: str = None,
        metadata: 'ProjectConfigMetadataCommon' = None,
    ) -> None:
        """
        ...
        :param ProjectConfigMetadataCommon metadata: (optional) The configuration
               metadata.
        """
        self.id = id
        self.name = name
    ...
    def from_dict(cls, _dict: Dict) -> 'ProjectConfigCollectionMember':
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in ProjectConfigCollectionMember JSON')
        if 'labels' in _dict:
            args['labels'] = _dict.get('labels')
        if 'description' in _dict:
            args['description'] = _dict.get('description')
        ...
        if 'locator_id' in _dict:
            ...
            raise ValueError('Required property \'locator_id\' not present in ProjectConfigCollectionMember JSON')
        if 'type' in _dict:
            args['type'] = _dict.get('type')
        else:
            raise ValueError('Required property \'type\' not present in ProjectConfigCollectionMember JSON')
        if 'input' in _dict:
            args['input'] = [InputVariable.from_dict(v) for v in _dict.get('input')]
        if 'output' in _dict:
            args['output'] = [OutputValue.from_dict(v) for v in _dict.get('output')]
        ...
        if 'href' in _dict:
            args['href'] = _dict.get('href')
        if 'metadata' in _dict:
            args['metadata'] = ProjectConfigMetadataCommon.from_dict(_dict.get('metadata'))
        return cls(**args)
...
class ProjectConfigDelete:
    ...
    :attr str id: (optional) The unique ID of a project.
    :attr str name: (optional) The name of the configuration being deleted.
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param str id: (optional) The unique ID of a project.
        :param str name: (optional) The name of the configuration being deleted.
        """
        self.id = id
        self.name = name
...
class ProjectConfigDraft:
    ...
    :attr List[ProjectConfigSettingCollection] setting: (optional) Schematics
          environment variables to use to deploy the configuration.
    :attr ProjectConfigDraftMetadata metadata: (optional) The project configuration
          draft.
    """
    ...
    def __init__(
        ...
        *,
        ...
        output: List['OutputValue'] = None,
        setting: List['ProjectConfigSettingCollection'] = None,
        metadata: 'ProjectConfigDraftMetadata' = None,
    ) -> None:
        """
        Initialize a ProjectConfigDraft object.
        ...
        :param List[ProjectConfigSettingCollection] setting: (optional) Schematics
               environment variables to use to deploy the configuration.
        :param ProjectConfigDraftMetadata metadata: (optional) The project
               configuration draft.
        """
        self.id = id
        self.name = name
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ProjectConfigDraft':
        """Initialize a ProjectConfigDraft object from a json dictionary."""
        args = {}
        if 'id' in _dict:
            args['id'] = _dict.get('id')
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in ProjectConfigDraft JSON')
        if 'labels' in _dict:
            args['labels'] = _dict.get('labels')
        if 'description' in _dict:
            args['description'] = _dict.get('description')
        ...
        if 'locator_id' in _dict:
            ...
            raise ValueError('Required property \'locator_id\' not present in ProjectConfigDraft JSON')
        if 'type' in _dict:
            args['type'] = _dict.get('type')
        else:
            raise ValueError('Required property \'type\' not present in ProjectConfigDraft JSON')
        if 'input' in _dict:
            args['input'] = [InputVariable.from_dict(v) for v in _dict.get('input')]
        if 'output' in _dict:
            args['output'] = [OutputValue.from_dict(v) for v in _dict.get('output')]
        if 'setting' in _dict:
            args['setting'] = [ProjectConfigSettingCollection.from_dict(v) for v in _dict.get('setting')]
        if 'metadata' in _dict:
            args['metadata'] = ProjectConfigDraftMetadata.from_dict(_dict.get('metadata'))
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ProjectConfigDraft object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ProjectConfigDraft') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectConfigDraft') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ProjectConfigDraftMetadata:
    ...
    :attr str project_id: (optional) The unique ID of a project.
    :attr int version: (optional) The version number of the configuration.
    :attr str state: (optional) The state of the configuration draft.
    :attr str pipeline_state: (optional) The pipeline state of the configuration.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a ProjectConfigDraftMetadata object.

        :param str project_id: (optional) The unique ID of a project.
        :param int version: (optional) The version number of the configuration.
        :param str state: (optional) The state of the configuration draft.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ProjectConfigDraftMetadata':
        """Initialize a ProjectConfigDraftMetadata object from a json dictionary."""
        args = {}
        if 'project_id' in _dict:
            args['project_id'] = _dict.get('project_id')
        if 'version' in _dict:
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ProjectConfigDraftMetadata object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ProjectConfigDraftMetadata') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectConfigDraftMetadata') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ProjectConfigGetResponse:
    ...
    :attr ProjectConfigDraftSummary active_draft: (optional) The project
          configuration draft.
    :attr ProjectConfigMetadata metadata: (optional) The configuration metadata.
    """
    ...
    def __init__(
        ...
        *,
        ...
        setting: List['ProjectConfigSettingCollection'] = None,
        active_draft: 'ProjectConfigDraftSummary' = None,
        metadata: 'ProjectConfigMetadata' = None,
    ) -> None:
        """
        ...
        :param ProjectConfigDraftSummary active_draft: (optional) The project
               configuration draft.
        :param ProjectConfigMetadata metadata: (optional) The configuration
               metadata.
        """
        self.id = id
        self.name = name
    ...
    def from_dict(cls, _dict: Dict) -> 'ProjectConfigGetResponse':
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in ProjectConfigGetResponse JSON')
        if 'labels' in _dict:
            args['labels'] = _dict.get('labels')
        if 'description' in _dict:
            args['description'] = _dict.get('description')
        ...
        if 'locator_id' in _dict:
            ...
            raise ValueError('Required property \'locator_id\' not present in ProjectConfigGetResponse JSON')
        if 'type' in _dict:
            args['type'] = _dict.get('type')
        else:
            raise ValueError('Required property \'type\' not present in ProjectConfigGetResponse JSON')
        if 'input' in _dict:
            args['input'] = [InputVariable.from_dict(v) for v in _dict.get('input')]
        if 'output' in _dict:
            args['output'] = [OutputValue.from_dict(v) for v in _dict.get('output')]
        ...
        if 'active_draft' in _dict:
            args['active_draft'] = ProjectConfigDraftSummary.from_dict(_dict.get('active_draft'))
        if 'metadata' in _dict:
            args['metadata'] = ProjectConfigMetadata.from_dict(_dict.get('metadata'))
        return cls(**args)
...
class ProjectConfigMetadata:
    """
    The configuration metadata.

    :attr str project_id: (optional) The unique ID of a project.
    :attr int version: (optional) The version of the configuration.
    :attr bool is_draft: (optional) The flag that indicates whether the version of
          the configuration is draft, or active.
    :attr List[object] needs_attention_state: (optional) The needs attention state
          of a configuration.
    :attr str state: (optional) The state of the configuration.
    :attr str pipeline_state: (optional) The pipeline state of the configuration.
    ...
    :attr datetime updated_at: (optional) A date and time value in the format
          YYYY-MM-DDTHH:mm:ssZ or YYYY-MM-DDTHH:mm:ss.sssZ, matching the date and time
          format as specified by RFC 3339.
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a ProjectConfigMetadata object.

        :param str project_id: (optional) The unique ID of a project.
        :param int version: (optional) The version of the configuration.
        :param bool is_draft: (optional) The flag that indicates whether the
               version of the configuration is draft, or active.
        :param List[object] needs_attention_state: (optional) The needs attention
               state of a configuration.
        :param str state: (optional) The state of the configuration.
        :param str pipeline_state: (optional) The pipeline state of the
               configuration.
        ...
        :param datetime updated_at: (optional) A date and time value in the format
               YYYY-MM-DDTHH:mm:ssZ or YYYY-MM-DDTHH:mm:ss.sssZ, matching the date and
               time format as specified by RFC 3339.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ProjectConfigMetadata':
        """Initialize a ProjectConfigMetadata object from a json dictionary."""
        args = {}
        if 'project_id' in _dict:
            args['project_id'] = _dict.get('project_id')
        if 'version' in _dict:
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ProjectConfigMetadata object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ProjectConfigMetadata') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectConfigMetadata') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other


class ProjectConfigMetadataCommon:
    """
    The configuration metadata.
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a ProjectConfigMetadataCommon object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ProjectConfigMetadataCommon':
        """Initialize a ProjectConfigMetadataCommon object from a json dictionary."""
        args = {}
        if 'project_id' in _dict:
            args['project_id'] = _dict.get('project_id')
        if 'version' in _dict:
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ProjectConfigMetadataCommon object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ProjectConfigMetadataCommon') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectConfigMetadataCommon') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ProjectConfigMetadataLastApproved:
    ...
    :attr bool is_forced: (optional) The flag that indicates whether the approval
          was forced approved.
    ...
    def __init__(
        ...
        *,
        ...
        :param bool is_forced: (optional) The flag that indicates whether the
               approval was forced approved.
...
class ProjectMetadata:
    ...
    :attr str cumulative_needs_attention_view_err: (optional) True indicates that
          the fetch of the needs attention items failed.
    ...
    def __init__(
        ...
        *,
        ...
        cumulative_needs_attention_view_err: str = None,
        location: str = None,
        ...
        """
        Initialize a ProjectMetadata object.
        ...
        :param List[CumulativeNeedsAttention] cumulative_needs_attention_view:
               (optional) The cumulative list of needs attention items for a project.
        :param str cumulative_needs_attention_view_err: (optional) True indicates
               that the fetch of the needs attention items failed.
        ...
        self.cumulative_needs_attention_view_err = cumulative_needs_attention_view_err
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ProjectMetadata':
        """Initialize a ProjectMetadata object from a json dictionary."""
        args = {}
        if 'crn' in _dict:
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ProjectMetadata object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ProjectMetadata') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ProjectMetadata') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ProjectSummary:
    ...
    def from_dict(cls, _dict: Dict) -> 'ProjectSummary':
        ...
        if 'name' in _dict:
            ...
            raise ValueError('Required property \'name\' not present in ProjectSummary JSON')
        if 'description' in _dict:
            args['description'] = _dict.get('description')
        if 'destroy_on_delete' in _dict:
            args['destroy_on_delete'] = _dict.get('destroy_on_delete')
